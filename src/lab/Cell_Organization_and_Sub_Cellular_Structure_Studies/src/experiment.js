          ...
          //  demoCanvas.height = element[0].height;
			...
			function handleComplete() { /**handle complete function  */
			   ...
			   /** Cells inside the Binocular*/
                loadImages(queue.getResult("monitorCell_2_binoView"), "monitorCell_group_1", 0, 0, "", 0, cell_group_container_one); /** Unstained Onion epidermal cell */
                ...
                loadImages(queue.getResult("monitorCell_0_binoView"), "monitorCell_group_7", 0, 0, "", 0, cell_group_container_one);
            ...
            /** This help array shows the hints for this experiment */
				...
				scope.heading = _("Cell Organization and Sub Cellular Structure Studies (Prokaryotic and Eukaryotic)");
				...
				scope.selectSamplePlaceholder = _("Staphylococcus aurcus (coccus)");
				...
				scope.selectsampleArray = [{optionsSample: _('Staphylococcus aurcus (coccus)'),type: 0}, {optionsSample: _('Bacillus Subtilis (rods)'),type: 1}, {optionsSample: _('Gram positive cocci'),type: 2}, {optionsSample: _('Gram positive rods'),type: 3}, {optionsSample: _('Gram negative cocci'),type: 4}, {optionsSample: _('Gram negative rods'),type: 5}, {optionsSample: _('Unstained Onion epidermal cell'),type: 6}, {optionsSample: _('Onion Cell'),type: 7}, {optionsSample: _('Cheek Cell'),type: 8}, {optionsSample: _('Onion Root Tips'),type: 9}];
				scope.$apply();
            }
        }
    }
...
/** Function for changing the user view *///** =========== Controls Section =========*/
...
function cellName() { /** Adding the name of the cells in an array  */
    ...
    for(var i=0;i<10;i++){
        ...
        var binocular_cell_count="binocular_cell_"+i;/**Generating the call name for cells inside the binocular  */
        var binocular_cell_name="monitorCell_group_"+(i+1);
        binocular_cell_count=cell_group_container_one.getChildByName(binocular_cell_name);/**Adding the cell name to the corresponding container */
        binocular_cell_array[i]=binocular_cell_count;
    }
}
